...
android {
    namespace = "com.example.practiceleakcanary"
    compileSdk = 34


    defaultConfig {
        applicationId = "com.example.practiceleakcanary"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
//    testImplementation ("com.squareup.leakcanary:leakcanary-android-no-op:2.14")
